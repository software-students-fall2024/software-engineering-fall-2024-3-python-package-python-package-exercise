...
## PyPI Link
[Riddle Handler](https://pypi.org/project/riddle-handler/1.0.4/)
...
```bash
pip install riddle-handler==1.0.4
```
...
## Update Log
v1.0.4
Bug Fix: Resolved the issue where user cannot import functions from package. Change the libarary paths.
